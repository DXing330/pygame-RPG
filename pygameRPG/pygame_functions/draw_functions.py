...
def draw_inn_menu():
        sleep_text = REG_FONT.render("SLEEP: S", 1, P.BLUE)
        ...
        talk_text = REG_FONT.render("RECRUIT: R", 1, P.BLUE)
        WIN.blit(talk_text, ((P.WIDTH - talk_text.get_width())//2, P.PADDING * 3))
        privacy_text = REG_FONT.render("PRIVATE Room: P", 1, P.BLUE)
        WIN.blit(privacy_text, ((P.WIDTH - privacy_text.get_width())//2, P.PADDING * 4))
def draw_proom_menu():
        leave_text = REG_FONT.render("LEAVE: L", 1, P.BLUE)
        WIN.blit(leave_text, ((P.WIDTH - leave_text.get_width())//2, P.PADDING * 2))
        adjust_party_text = REG_FONT.render("Change PARTY order: P", 1, P.BLUE)
        ...
        adjust_weapon_text = REG_FONT.render("Change WEAPONS: W", 1, P.BLUE)
        WIN.blit(adjust_weapon_text, ((P.WIDTH - adjust_weapon_text.get_width())//2, P.PADDING * 5))
        adjust_armor_text = REG_FONT.render("Change ARMORS: A", 1, P.BLUE)
...
def draw_prreorder_menu(h_p):
        ...
        x = 1
        last_text = REG_FONT.render("Who should act last?", 1, P.BLACK)
...
def draw_prremove_menu(h_p):
        ...
        x = 1
        remove_text = REG_FONT.render("Who should leave the party?", 1, P.BLACK)
        WIN.blit(remove_text, ((P.WIDTH - remove_text.get_width())//2, P.PADDING))
        warning_text = REG_FONT.render("You may never see them again.", 1, P.BLACK)
